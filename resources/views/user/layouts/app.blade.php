    ...
    <nav class="px-4 py-6 flex-1 overflow-y-auto">
        <div class="space-y-2">
            ...
            <a href="{{ route('user.dashboard') }}"
               ...
               @if(request()->routeIs('user.dashboard')) bg-gradient-to-r from-green-500 to-green-600 text-white shadow-lg @endif">
            ...
            <a href="{{ route('user.products.index') }}"
               class="flex items-center px-4 py-3 text-gray-300 rounded-xl hover:bg-gray-700/50 hover:text-white transition-all duration-200 group
               @if(request()->routeIs('user.products.*')) bg-gradient-to-r from-green-500 to-green-600 text-white shadow-lg @endif">
                <div class="w-8 h-8 flex items-center justify-center mr-3 rounded-lg bg-gray-700 group-hover:bg-gray-600 transition-colors">
            ...
            <a href="{{ route('user.transactions.index') }}"
               class="flex items-center px-4 py-3 text-gray-300 rounded-xl hover:bg-gray-700/50 hover:text-white transition-all duration-200 group
               @if(request()->routeIs('user.transactions.*')) bg-gradient-to-r from-green-500 to-green-600 text-white shadow-lg @endif">
                <div class="w-8 h-8 flex items-center justify-center mr-3 rounded-lg bg-gray-700 group-hover:bg-gray-600 transition-colors">
    ...
    <header class="bg-gradient-to-r from-green-500 to-blue-700 shadow-lg sticky top-0 z-10">
        <div class="flex items-center justify-between px-4 sm:px-6 lg:px-8 py-4">
            ...
            <div class="flex items-center space-x-4">
                ...
                <h1 class="text-2xl sm:text-3xl font-bold text-white tracking-wide">ARKATAMA</h1>
            </div>
