        ...
        <div class="p-6 border-b">
            ...
            @else
                <div class="bg-yellow-50 border-2 border-yellow-300 rounded-lg p-8 text-center">
                    ...
                    <p class="text-gray-700 font-semibold mb-2">No payment proof uploaded yet</p>
                    <p class="text-gray-600 text-sm mb-4">Please upload your payment proof to process this transaction</p>
