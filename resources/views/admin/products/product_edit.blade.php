    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    <label class="block text-gray-700 font-semibold mb-2">
                        <span class="text-lg mr-1">💰</span> Price
                        <span class="text-red-500">*</span>
                    </label>
                    <input type="number" 
                           name="price" 
                           ...
                           step="0.01"
                           required>
                    <p class="text-sm text-gray-500 mt-1">Input harga dalam angka, tanpa simbol "Rp". Contoh: 150000 = Rp150.000</p>
                </div>
            ...
            <div class="mb-6">
                ...
                <textarea name="description" 
                          ...
                          placeholder="Input product description here">{{ old('description', $product->description) }}</textarea>
            </div>
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors">
                    ...
                    <label for="imageInput" class="cursor-pointer">
                        <div id="imagePreview" class="mb-4">
                            @if($product->image)
                                <img src="{{ asset('storage/products/'.$product->image) }}" class="max-w-full h-48 mx-auto rounded-lg shadow-md mb-2">
